...
face = cv2.CascadeClassifier("C:\\Users\\HP\\Downloads\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_default.xml")
glass_cas = cv2.CascadeClassifier("C:\\Users\\HP\\Downloads\\opencv\\sources\\data\\haarcascades\\haarcascade_eye_tree_eyeglasses.xml")

WHITE = [255, 255, 255]

def FileRead():
    Info = open("C:\\Python27\\face\\Names.txt", "r")   # Open th text file in readmode
...
def AddName():
    ...
    Info = open("C:\\Python27\\face\\Names.txt", "r+")
