...
EigenFace = cv2.createEigenFaceRecognizer(15)      # creating EIGEN FACE RECOGNISER
FisherFace = cv2.createFisherFaceRecognizer(2)     # Create FISHER FACE RECOGNISER
...
print('EIGEN FACE XML SAVED SAVED...')
